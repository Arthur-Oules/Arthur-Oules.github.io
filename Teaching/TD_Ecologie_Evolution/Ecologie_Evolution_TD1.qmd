---
title: "TD Ecologie-Evolution: Phylogénie et Ecologie"
author:
  - name: "Arthur Oulès"
  ...
  - name: "Björn Wissel"
    email: bjoern.wissel@univ-lyon1.fr
    affiliation:
      - name: Laboratoire d'Ecologie des Hydrosystèmes Naturels et Anthropisés – UMR 5023
        city: Villeurbanne
        country: France
        url: https://umr5023.univ-lyon1.fr/
description: "Tutorial on the use of phylogenies in reconstructing ancestral states."
categories: Tutorial
lang: fr
...
Mâchoires pharyngiennes d'une Murène (Mehta&Wainright 2007) DOI : [10.1038/nature06062](https://www.nature.com/articles/nature06062){style="font-size: 11pt;"}
:::

::: {#fig-cichlids}
![](figures/Cichlids_pjawsteeth.png)

Diversité des mâchoires pharyngiennes des Cichlidés (Burress 2015) DOI : [10.1111/1365-2656.12457](https://doi.org/10.1111/1365-2656.12457){style="font-size: 11pt;"}
:::
...
::: {#doc-one layout="[-10, 80, -10]"}
![](figures/Doc_1.svg)

**Impact de la pharyngognathie sur la transition de régime alimentaire chez les poissons marins.** (McGee *et al* 2015) DOI : [10.1126/science.aab0800](https://doi.org/10.1126/science.aab0800){style="font-size: 11pt;"}
...
**Phylogénie RAxML des Tropheini calibrée temporellement et faisant apparaître les reconstructions des traits ancestraux pour la spécialisation trophique.** (Singh *et al* 2022) DOI : [10.1002/ece3.9077](https://doi.org/10.1002/ece3.9077){style="font-size: 11pt;"}
