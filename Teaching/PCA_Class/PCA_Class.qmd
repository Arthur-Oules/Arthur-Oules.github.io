...
On retrouve une décomposition en valeurs propres. En décomposant $x$ en valeurs singulièress, on s'évite de passer par le calcul de son inverse.
...
*   Cette analyse permet de réduire la dimensionnalité des données et les résumes par des composantes principales
...
* Le nouvel espace est Euclidien, on peut y mesurer des ditances et des angles. Attention cependant à leur interprétation !
